...
class ConfirmStackView: UIStackView {
    
    //Customise the OTPField here
    let numberOfFields = 6
    var textFieldsCollection: [ConfirmTextField] = []
    ...
    private final func setupTextField(_ textField: ConfirmTextField){
...
extension ConfirmStackView: UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range:NSRange,
        ...
        guard let textField = textField as? ConfirmTextField else { return true }
        if string.count > 1 {
